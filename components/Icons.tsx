...
export const AdvRobotIcon = ({ className }: { className?: string }) => (
  <img 
    src="https://lh3.googleusercontent.com/d/1v-49zdUqzGvm5ulY--ctHgzEp6Ch-b1p" 
    alt="AdvRobot Logo" 
...
export const AssistantsIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
